...
#| Answer:
There are 4 parts that make up this stream:
1) the triplet s0, t0, u0
2) the triplet of s0, t0, and all the values u1 and on [(s0, t0, u2), (s0, t0, u3), (s0, t0, u4), etc]
3) the triplet of 
|#
...
(define tx (triples integers integers integers))
(define px (pyt-triples tx))
(display-n-terms px 5)